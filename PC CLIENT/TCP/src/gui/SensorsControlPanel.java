	...
	public SensorsControlPanel(GUI g) {
		...
		slider.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent arg0) {
				if(!g.tcp.rd.is_moving_from_extern){
		...
		chckbxNewCheckBox = new JCheckBox("activate alarm on temperature");
		...
		chckbxNewCheckBox_1 = new JCheckBox("turn on all leds where there is no light in the area");
		...
		chckbxNewCheckBox_2 = new JCheckBox("activate alarm on presence");
