...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  hButton = BUTTON_Create(142, 100, 50, 50,ID_BUTTON_0, WM_CF_SHOW);
  ...
  case WM_INIT_DIALOG:
    ...
    BUTTON_SetBitmap(hButton, BUTTON_BI_DISABLED, &bmdebug_icon);
    BUTTON_SetBitmap(hButton, BUTTON_BI_PRESSED, &bmdebug_icon);
    BUTTON_SetBitmap(hButton, BUTTON_BI_UNPRESSED, &bmdebug_icon);
