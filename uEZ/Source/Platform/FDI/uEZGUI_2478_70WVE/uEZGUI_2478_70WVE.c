...
/*---------------------------------------------------------------------------*
 * Routine:  UEZGUI70WVE_AudioMixerCallback
 *---------------------------------------------------------------------------*
 * Description:
 *
 *---------------------------------------------------------------------------*/
static T_uezError UEZGUI70WVE_AudioMixerCallback(
...
void UEZPlatform_AudioMixer_Require(void)
{
    ...
    UEZAudioMixerRegister(UEZ_AUDIO_MIXER_OUTPUT_ONBOARD_SPEAKER, &UEZGUI70WVE_AudioMixerCallback);
