...
#define PROCESSOR_OSCILLATOR_FREQUENCY      120000000   // clocks per second (when using LCD, must be slower)
    ...
    #define SDRAM_CLOCK_FREQUENCY               PROCESSOR_OSCILLATOR_FREQUENCY
#endif

#ifndef EMC_CLOCK_FREQUENCY
    #define EMC_CLOCK_FREQUENCY                 PROCESSOR_OSCILLATOR_FREQUENCY
#endif
...
TBool UEZGUIIsExpansionBoard70Connected();
...
void UEZPlatform_CRC_Require(void);
