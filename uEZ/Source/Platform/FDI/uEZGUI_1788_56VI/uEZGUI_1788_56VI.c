...
/*---------------------------------------------------------------------------*
 * Routine:  UEZPlatform_SSP2_Require
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the SSP2 to be a SPI driver
 *---------------------------------------------------------------------------*/
void UEZPlatform_SSP2_Require(void)
{
    ...
    LPC17xx_40xx_GPIO2_Require();
    LPC17xx_40xx_SSP2_Require(GPIO_P1_0, GPIO_P1_4, GPIO_P1_1, GPIO_NONE);
...
/*---------------------------------------------------------------------------*
 * Routine:  UEZGUI56VI_AudioMixerCallback
 *---------------------------------------------------------------------------*
 * Description:
 *
 *---------------------------------------------------------------------------*/
static T_uezError UEZGUI56VI_AudioMixerCallback(
...
void UEZPlatform_GainSpan_OnBoard_Require(void)
{
    LPC17xx_40xx_GPIO1_Require();
    UEZPlatform_SSP0_Require();
}
