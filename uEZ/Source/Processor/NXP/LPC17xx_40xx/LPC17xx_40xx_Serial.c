...
} T_Serial_LPC17xx_40xx_SerialInfo;

typedef struct {
    const HAL_Serial *iHAL;
    const T_Serial_LPC17xx_40xx_SerialInfo *iInfo;
...
} T_Serial_LPC17xx_40xx_Workspace;
 ...
 * Globals:
 *---------------------------------------------------------------------------*/
extern const HAL_Serial G_LPC17xx_40xx_Serial_UART0;
extern const HAL_Serial G_LPC17xx_40xx_Serial_UART1;
extern const HAL_Serial G_LPC17xx_40xx_Serial_UART2;
extern const HAL_Serial G_LPC17xx_40xx_Serial_UART3;
extern const HAL_Serial G_LPC17xx_40xx_Serial_UART4;

extern const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART0;
extern const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART1;
extern const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART2;
extern const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART3;
extern const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART4;

T_Serial_LPC17xx_40xx_Workspace *G_UART0Workspace = 0;
T_Serial_LPC17xx_40xx_Workspace *G_UART1Workspace = 0;
T_Serial_LPC17xx_40xx_Workspace *G_UART2Workspace = 0;
T_Serial_LPC17xx_40xx_Workspace *G_UART3Workspace = 0;
T_Serial_LPC17xx_40xx_Workspace *G_UART4Workspace = 0;
 ...
 *---------------------------------------------------------------------------*/
static void ISerialProcessInterrupt(T_Serial_LPC17xx_40xx_Workspace *p)
{
    TUInt8 iir;
 ...
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_OutputByte(void *aWorkspace, TUInt8 aByte)
{
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_Deactivate(void *aWorkspace)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_Activate(void *aWorkspace)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_InitializeWorkspace_UART0
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_InitializeWorkspace_UART0(void *aWorkspace)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
    G_UART0Workspace = p;
    p->iInfo = &G_LPC17xx_40xx_Serial_Info_UART0;
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_InitializeWorkspace_UART1
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_InitializeWorkspace_UART1(void *aWorkspace)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
    G_UART1Workspace = p;
    p->iInfo = &G_LPC17xx_40xx_Serial_Info_UART1;
    p->iCallbackWorkspace = 0;
    p->iReceivedByteFunc = 0;
    p->iTransmitEmptyFunc = 0;
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_InitializeWorkspace_UART2
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_InitializeWorkspace_UART2(void *aWorkspace)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
    G_UART2Workspace = p;
    p->iInfo = &G_LPC17xx_40xx_Serial_Info_UART2;
    p->iCallbackWorkspace = 0;
    p->iReceivedByteFunc = 0;
    p->iTransmitEmptyFunc = 0;
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_InitializeWorkspace_UART3
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_InitializeWorkspace_UART3(void *aWorkspace)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
    G_UART3Workspace = p;
    p->iInfo = &G_LPC17xx_40xx_Serial_Info_UART3;
    p->iCallbackWorkspace = 0;
    p->iReceivedByteFunc = 0;
    p->iTransmitEmptyFunc = 0;
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_InitializeWorkspace_UART4
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_InitializeWorkspace_UART4(void *aWorkspace)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
    G_UART4Workspace = p;
    p->iInfo = &G_LPC17xx_40xx_Serial_Info_UART4;
    p->iCallbackWorkspace = 0;
    p->iReceivedByteFunc = 0;
    p->iTransmitEmptyFunc = 0;
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_GetSerialSettings
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_GetSerialSettings(
        void *aWorkspace,
        T_Serial_Settings *aSettings)
{
    T_Serial_LPC17xx_40xx_Workspace *p = (T_Serial_LPC17xx_40xx_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_SetHandshakingControl
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_SetHandshakingControl(
        void *aWorkspace,
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_GetHandshakingStatus
 *---------------------------------------------------------------------------*
 * Description:
 *      Set the handshaking control for this serial port (if it has it)
 * Inputs:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Serial_GetHandshakingStatus(
        void *aWorkspace,
...
/*---------------------------------------------------------------------------*
 * Routine: LPC17xx_40xx_Serial_GetStatus
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_serialStatusByte LPC17xx_40xx_Serial_GetStatus(void *aWorkspace)
{
...
const HAL_Serial G_LPC17xx_40xx_Serial_UART0 = {
        ...
        LPC17xx_40xx_Serial_Configure,
        LPC17xx_40xx_Serial_SetSerialSettings,
        LPC17xx_40xx_Serial_GetSerialSettings,
        LPC17xx_40xx_Serial_Activate,
        LPC17xx_40xx_Serial_Deactivate,
        LPC17xx_40xx_Serial_OutputByte,
        0,
        0,
        LPC17xx_40xx_Serial_GetStatus, };
...
const HAL_Serial G_LPC17xx_40xx_Serial_UART1 = {
        ...
        LPC17xx_40xx_Serial_Deactivate,
        LPC17xx_40xx_Serial_OutputByte,
        LPC17xx_40xx_Serial_SetHandshakingControl,
        LPC17xx_40xx_Serial_GetHandshakingStatus,
        LPC17xx_40xx_Serial_GetStatus, };
...
const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART0 = {
        UART0_IRQn,
...
const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART1 = {
        UART1_IRQn,
        INTERRUPT_PRIORITY_HIGH,
...
const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART2 = {
        UART2_IRQn,
        INTERRUPT_PRIORITY_HIGH,
...
const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART3 = {
        UART3_IRQn,
        INTERRUPT_PRIORITY_HIGH,
...
const T_Serial_LPC17xx_40xx_SerialInfo G_LPC17xx_40xx_Serial_Info_UART4 = {
        UART4_IRQn,
        INTERRUPT_PRIORITY_HIGH,
 ...
 *---------------------------------------------------------------------------*/
void LPC17xx_40xx_UART0_Require(
        T_uezGPIOPortPin aPinTXD0,
        T_uezGPIOPortPin aPinRXD0)
{
    static const T_LPC17xx_40xx_IOCON_ConfigList txd0[] = {
            {GPIO_P0_0,   IOCON_D_DEFAULT(4)},
            {GPIO_P0_2,   IOCON_D_DEFAULT(1)},
    };
    static const T_LPC17xx_40xx_IOCON_ConfigList rxd0[] = {
            {GPIO_P0_1,   IOCON_D_DEFAULT(4)},
            {GPIO_P0_3,   IOCON_D_DEFAULT(1)},
    };

    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("UART0", (T_halInterface *)&G_LPC17xx_40xx_Serial_UART0, 0,
            0);
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinTXD0, txd0, ARRAY_COUNT(txd0));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinRXD0, rxd0, ARRAY_COUNT(rxd0));
}

void LPC17xx_40xx_UART1_Require(
        ...
        T_uezGPIOPortPin aPinRTS)
{
    ...
    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("UART1", (T_halInterface *)&G_LPC17xx_40xx_Serial_UART1, 0,
            0);
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinTXD1, txd1, ARRAY_COUNT(txd1));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinRXD1, rxd1, ARRAY_COUNT(rxd1));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinCTS, cts, ARRAY_COUNT(cts));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinDCD, dcd, ARRAY_COUNT(dcd));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinDSR, dsr, ARRAY_COUNT(dsr));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinDTR, dtr, ARRAY_COUNT(dtr));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinRI, ri, ARRAY_COUNT(ri));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinRTS, rts, ARRAY_COUNT(rts));
}

void LPC17xx_40xx_UART2_Require(
        T_uezGPIOPortPin aPinTXD2,
        T_uezGPIOPortPin aPinRXD2)
{
    static const T_LPC17xx_40xx_IOCON_ConfigList txd2[] = {
            {GPIO_P0_10, IOCON_D_DEFAULT(1)},
            {GPIO_P2_8,  IOCON_D_DEFAULT(2)},
            {GPIO_P4_22, IOCON_D_DEFAULT(2)},
    };
    static const T_LPC17xx_40xx_IOCON_ConfigList rxd2[] = {
    ...
    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("UART2", (T_halInterface *)&G_LPC17xx_40xx_Serial_UART2, 0,
            0);
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinTXD2, txd2, ARRAY_COUNT(txd2));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinRXD2, rxd2, ARRAY_COUNT(rxd2));
}

void LPC17xx_40xx_UART3_Require(
        T_uezGPIOPortPin aPinTXD3,
        T_uezGPIOPortPin aPinRXD3)
{
    static const T_LPC17xx_40xx_IOCON_ConfigList txd3[] = {
            {GPIO_P0_0,  IOCON_D_DEFAULT(2)},
            {GPIO_P0_2,  IOCON_D_DEFAULT(2)},
            {GPIO_P0_25, IOCON_A_DEFAULT(3)},
            {GPIO_P4_28, IOCON_D_DEFAULT(2)},
    };
    static const T_LPC17xx_40xx_IOCON_ConfigList rxd3[] = {
    ...
    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("UART3", (T_halInterface *)&G_LPC17xx_40xx_Serial_UART3, 0,
            0);
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinTXD3, txd3, ARRAY_COUNT(txd3));
    LPC17xx_40xx_IOCON_ConfigPinOrNone(aPinRXD3, rxd3, ARRAY_COUNT(rxd3));
}
