/*-------------------------------------------------------------------------*
 * File:  LPC17xx_40xx_I2S.h
 *-------------------------------------------------------------------------*
 * Description:
 *     
 *-------------------------------------------------------------------------*/
#ifndef LPC17xx_40xx_I2S_H_
#define LPC17xx_40xx_I2S_H_
...
} T_LPC17xx_40xx_I2S_Settings;

/*-------------------------------------------------------------------------*
 * Prototypes:
 *-------------------------------------------------------------------------*/
extern const HAL_I2S G_LPC17xx_40xx_I2S_Interface;
void LPC17xx_40xx_I2S_Require(const T_LPC17xx_40xx_I2S_Settings *aSettings);

#endif // LPC17xx_40xx_I2S_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC17xx_40xx_I2S.h
 *-------------------------------------------------------------------------*/
