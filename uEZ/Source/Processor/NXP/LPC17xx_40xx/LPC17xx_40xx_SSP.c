 ...
 *-------------------------------------------------------------------------*
 * Description:
 *      HAL implementation of the LPC17xx_40xx SSP Bus Interface.
 * Implementation:
...
} T_LPC17xx_40xx_SSP_Registers;

typedef struct {
    const HAL_SPI *iHAL;
    T_LPC17xx_40xx_SSP_Registers *iReg;
...
static void ISSPProcessInterrupt(T_LPC17xx_40xx_SSP_Workspace *aW);
static void ISSPOutput(T_LPC17xx_40xx_SSP_Workspace *aW);

/*---------------------------------------------------------------------------*
 * Globals:
 *---------------------------------------------------------------------------*/
static T_LPC17xx_40xx_SSP_Workspace *G_SSP0Workspace;
static T_LPC17xx_40xx_SSP_Workspace *G_SSP1Workspace;
static T_LPC17xx_40xx_SSP_Workspace *G_SSP2Workspace;
 ...
 * Outputs:
 *      T_LPC17xx_40xx_SSP_Workspace *aW -- Particular SSP workspace
 *      SPI_Request *aRequest      -- Configuration of SSP device
 *---------------------------------------------------------------------------*/
static void ISSPConfig(T_LPC17xx_40xx_SSP_Workspace *aW, SPI_Request *aRequest)
{
    T_LPC17xx_40xx_SSP_Registers *p = aW->iReg;
    TUInt32 scr;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_SSP_TransferPolled
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_SSP_TransferPolled(void *aWorkspace, SPI_Request *aRequest)
{
    TUInt32 i;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_SSP_SSP0_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the LPC17xx_40xx SSP0 workspace.
 * Inputs:
 *      void *aW                    -- Particular SSP workspace
 * Outputs:
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_SSP_SSP0_InitializeWorkspace(void *aWorkspace)
{
    T_LPC17xx_40xx_SSP_Workspace *p = (T_LPC17xx_40xx_SSP_Workspace *)aWorkspace;
    p->iReg = (T_LPC17xx_40xx_SSP_Registers *)LPC_SSP0_BASE;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_SSP_SSP1_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the LPC17xx_40xx SSP1 workspace.
 * Inputs:
 *      void *aW                    -- Particular SSP workspace
 * Outputs:
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_SSP_SSP1_InitializeWorkspace(void *aWorkspace)
{
    T_LPC17xx_40xx_SSP_Workspace *p = (T_LPC17xx_40xx_SSP_Workspace *)aWorkspace;
    p->iReg = (T_LPC17xx_40xx_SSP_Registers *)LPC_SSP1_BASE;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_SSP_SSP2_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the LPC17xx_40xx SSP2 workspace.
 * Inputs:
 *      void *aW                    -- Particular SSP workspace
 * Outputs:
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_SSP_SSP2_InitializeWorkspace(void *aWorkspace)
{
    T_LPC17xx_40xx_SSP_Workspace *p = (T_LPC17xx_40xx_SSP_Workspace *)aWorkspace;
    p->iReg = (T_LPC17xx_40xx_SSP_Registers *)LPC_SSP2_BASE;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_SSP_Start
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
void LPC17xx_40xx_SSP_Start(void *aWorkspace, SPI_Request *aRequest)
{
    // Setup SSP for this configuration
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_SSP_TransferInOut
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
static TUInt32 LPC17xx_40xx_SSP_TransferInOut(
        void *aWorkspace,
 ...
 *      SPI_Request *aRequest       -- SSP request being processed
 *---------------------------------------------------------------------------*/
static void LPC17xx_40xx_SSP_Stop(void *aWorkspace, SPI_Request *aRequest)
{
    ISSPEnd(aRequest);
}
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
static T_uezError LPC17xx_40xx_SSP_TransferInOutBytes(
        void *aWorkspace,
        SPI_Request *aRequest)
{
    T_LPC17xx_40xx_SSP_Workspace *aW = (T_LPC17xx_40xx_SSP_Workspace *)aWorkspace;
...
static TBool LPC17xx_40xx_SSP_IsBusy(void *aWorkspace)
{
    T_LPC17xx_40xx_SSP_Workspace *aW = (T_LPC17xx_40xx_SSP_Workspace *)aWorkspace;
 ...
 * HAL Interface table:
 *---------------------------------------------------------------------------*/
const HAL_SPI SSP_LPC17xx_40xx_Port0_Interface = {
        {
        "NXP:LPC17xx_40xx:SSP0",
        0x0202,
        LPC17xx_40xx_SSP_SSP0_InitializeWorkspace,
        sizeof(T_LPC17xx_40xx_SSP_Workspace),
        },

        LPC17xx_40xx_SSP_TransferPolled,

        LPC17xx_40xx_SSP_Start,
        LPC17xx_40xx_SSP_TransferInOut,
        LPC17xx_40xx_SSP_Stop,
        LPC17xx_40xx_SSP_TransferInOutBytes,

        // uEZ v2.02
        LPC17xx_40xx_SSP_TransferNoBlock,
...
const HAL_SPI SSP_LPC17xx_40xx_Port1_Interface = {
        ...
        0x0202,
        LPC17xx_40xx_SSP_SSP1_InitializeWorkspace,
        sizeof(T_LPC17xx_40xx_SSP_Workspace),
        },
...
const HAL_SPI SSP_LPC17xx_40xx_Port2_Interface = {
        {
        "NXP:LPC17xx_40xx:SSP2",
        0x0202,
        LPC17xx_40xx_SSP_SSP2_InitializeWorkspace,
        sizeof(T_LPC17xx_40xx_SSP_Workspace),
        },
