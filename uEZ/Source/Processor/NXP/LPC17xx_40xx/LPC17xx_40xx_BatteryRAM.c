/*-------------------------------------------------------------------------*
 * File:  LPC17xx_40xx_BatteryRAM.c
 *-------------------------------------------------------------------------*
 * Description:
 *      HAL implementation of the LPC17xx_40xx Battery RAM Interface.
 * Implementation:
...
typedef struct {
    ...
    TBool iContentValid;
} T_LPC17xx_40xx_BatteryRAM_Workspace;

/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_BatteryRAM_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the LPC17xx_40xx BatteryRAM workspace.
 * Inputs:
 *      void *aW                    -- Particular BatteryRAM workspace
 * Outputs:
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_BatteryRAM_InitializeWorkspace(void *aWorkspace)
{

    T_LPC17xx_40xx_BatteryRAM_Workspace *p =
            (T_LPC17xx_40xx_BatteryRAM_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_BatteryRAM_Read
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_BatteryRAM_Read(
        void *aWorkspace,
        const TUInt32 aAddr,
        TUInt8 *aData)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_BatteryRAM_Write
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_BatteryRAM_Write(
        void *aWorkspace,
        const TUInt32 aAddr,
        const TUInt8 aData)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_BatteryRAM_Valid
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
TBool LPC17xx_40xx_BatteryRAM_IsValid(void *aWorkspace)
{
    T_LPC17xx_40xx_BatteryRAM_Workspace *p =
            (T_LPC17xx_40xx_BatteryRAM_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_BatteryRAM_GetSize
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
TUInt32 LPC17xx_40xx_BatteryRAM_GetSize(void *aWorkspace)
{
 ...
 *---------------------------------------------------------------------------*/
const HAL_BatteryRAM LPC17xx_40xx_BatteryRAM_Interface = {
        {
                "LPC17xx_40xx:BatteryRAM",
                0x0100,
                LPC17xx_40xx_BatteryRAM_InitializeWorkspace,
                sizeof(T_LPC17xx_40xx_BatteryRAM_Workspace), },

        LPC17xx_40xx_BatteryRAM_Read,
        LPC17xx_40xx_BatteryRAM_Write,
        LPC17xx_40xx_BatteryRAM_IsValid,
        LPC17xx_40xx_BatteryRAM_GetSize };

/*---------------------------------------------------------------------------*
 * Requirement routines:
 *---------------------------------------------------------------------------*/
void LPC17xx_40xx_BatteryRAM_Require(void)
{
    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("BatteryRAM",
            (T_halInterface *)&LPC17xx_40xx_BatteryRAM_Interface, 0, 0);
}

/*-------------------------------------------------------------------------*
 * End of File:  LPC17xx_40xx_BatteryRAM.c
 *-------------------------------------------------------------------------*/
