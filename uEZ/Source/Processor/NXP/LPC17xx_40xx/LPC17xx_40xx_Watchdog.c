 ...
 *-------------------------------------------------------------------------*
 * Description:
 *      HAL implementation of the LPC17xx_40xx Watchdog Interface.
 * Implementation:
...
} T_LPC17xx_40xx_Watchdog_Workspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_SetMaximumTime
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
static T_uezError LPC17xx_40xx_Watchdog_SetMaximumTime(
        void *aWorkspace,
        TUInt32 aMaxTime)
{
    T_LPC17xx_40xx_Watchdog_Workspace *p =
            (T_LPC17xx_40xx_Watchdog_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_SetMinimumTime
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
static T_uezError LPC17xx_40xx_Watchdog_SetMinimumTime(
        void *aWorkspace,
        TUInt32 aMinTime)
{
    T_LPC17xx_40xx_Watchdog_Workspace *p =
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_IsResetFromWatchdog
 *---------------------------------------------------------------------------*
 * Description:
 *      Set the minimum amount of time that must go by before feeding the
 *      watchdog.
 ...
 *                                      EFalse.
 *---------------------------------------------------------------------------*/
static TBool LPC17xx_40xx_Watchdog_IsResetFromWatchdog(void *aWorkspace)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_ClearResetFlag
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      void *aWorkspace            -- Workspace
 *---------------------------------------------------------------------------*/
static void LPC17xx_40xx_Watchdog_ClearResetFlag(void *aWorkspace)
{
    PARAM_NOT_USED(aWorkspace);
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_IsActive
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *                                      EFalse.
 *---------------------------------------------------------------------------*/
static TBool LPC17xx_40xx_Watchdog_IsActive(void *aWorkspace)
{
    T_LPC17xx_40xx_Watchdog_Workspace *p =
            (T_LPC17xx_40xx_Watchdog_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_Start
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *                                      EFalse.
 *---------------------------------------------------------------------------*/
static T_uezError LPC17xx_40xx_Watchdog_Start(void *aWorkspace)
{
    T_LPC17xx_40xx_Watchdog_Workspace *p =
            (T_LPC17xx_40xx_Watchdog_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_Feed
 *---------------------------------------------------------------------------*
 * Description:
 *      Feed the watchdog.
 * Inputs:
 ...
 *                                      EFalse.
 *---------------------------------------------------------------------------*/
static T_uezError LPC17xx_40xx_Watchdog_Feed(void *aWorkspace)
{
    T_LPC17xx_40xx_Watchdog_Workspace *p =
            (T_LPC17xx_40xx_Watchdog_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_Trip
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                  -- Error code
 *---------------------------------------------------------------------------*/
static T_uezError LPC17xx_40xx_Watchdog_Trip(void *aWorkspace)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC17xx_40xx_Watchdog_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the LPC17xx_40xx Watchdog workspace.
 * Inputs:
 *      void *aW                    -- Particular Watchdog workspace
 * Outputs:
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC17xx_40xx_Watchdog_InitializeWorkspace(void *aWorkspace)
{
    T_LPC17xx_40xx_Watchdog_Workspace *p =
            (T_LPC17xx_40xx_Watchdog_Workspace *)aWorkspace;
    p->iIsActive = EFalse;
 ...
 *---------------------------------------------------------------------------*/
const HAL_Watchdog Watchdog_LPC17xx_40xx_Interface = {
        {
                "Watchdog:NXP:LPC17xx_40xx",
                0x0106,
                LPC17xx_40xx_Watchdog_InitializeWorkspace,
                sizeof(T_LPC17xx_40xx_Watchdog_Workspace), },

        LPC17xx_40xx_Watchdog_SetMaximumTime,
        LPC17xx_40xx_Watchdog_SetMinimumTime,
        LPC17xx_40xx_Watchdog_IsResetFromWatchdog,
        LPC17xx_40xx_Watchdog_ClearResetFlag,
        LPC17xx_40xx_Watchdog_IsActive,
        LPC17xx_40xx_Watchdog_Start,
        LPC17xx_40xx_Watchdog_Feed,
        LPC17xx_40xx_Watchdog_Trip };

/*---------------------------------------------------------------------------*
 * Requirement routines:
 *---------------------------------------------------------------------------*/
void LPC17xx_40xx_Watchdog_Require(void)
{
    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("Watchdog",
            (T_halInterface *)&Watchdog_LPC17xx_40xx_Interface, 0, 0);
}
