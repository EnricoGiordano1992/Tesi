/*-------------------------------------------------------------------------*
 * File:  LPC1788_BatteryRAM.c
 *-------------------------------------------------------------------------*
 * Description:
 *      HAL implementation of the LPC1788 Battery RAM Interface.
 * Implementation:
...
#include <Source/Processor/NXP/LPC1788/LPC1788_BatteryRAM.h>
...
typedef struct {
    ...
    TBool iContentValid;
} T_LPC1788_BatteryRAM_Workspace;

/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_BatteryRAM_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup the LPC1788 BatteryRAM workspace.
 * Inputs:
 *      void *aW                    -- Particular BatteryRAM workspace
 * Outputs:
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC1788_BatteryRAM_InitializeWorkspace(void *aWorkspace)
{

    T_LPC1788_BatteryRAM_Workspace *p =
            (T_LPC1788_BatteryRAM_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_BatteryRAM_Read
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC1788_BatteryRAM_Read(
        void *aWorkspace,
        const TUInt32 aAddr,
        TUInt8 *aData)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_BatteryRAM_Write
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC1788_BatteryRAM_Write(
        void *aWorkspace,
        const TUInt32 aAddr,
        const TUInt8 aData)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_BatteryRAM_Valid
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
TBool LPC1788_BatteryRAM_IsValid(void *aWorkspace)
{
    T_LPC1788_BatteryRAM_Workspace *p =
            (T_LPC1788_BatteryRAM_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_BatteryRAM_GetSize
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
TUInt32 LPC1788_BatteryRAM_GetSize(void *aWorkspace)
{
 ...
 *---------------------------------------------------------------------------*/
const HAL_BatteryRAM LPC1788_BatteryRAM_Interface = {
        {
                "LPC1788:BatteryRAM",
                0x0100,
                LPC1788_BatteryRAM_InitializeWorkspace,
                sizeof(T_LPC1788_BatteryRAM_Workspace), },

        LPC1788_BatteryRAM_Read,
        LPC1788_BatteryRAM_Write,
        LPC1788_BatteryRAM_IsValid,
        LPC1788_BatteryRAM_GetSize };

/*---------------------------------------------------------------------------*
 * Requirement routines:
 *---------------------------------------------------------------------------*/
void LPC1788_BatteryRAM_Require(void)
{
    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("BatteryRAM",
            (T_halInterface *)&LPC1788_BatteryRAM_Interface, 0, 0);
}

/*-------------------------------------------------------------------------*
 * End of File:  LPC1788_BatteryRAM.c
 *-------------------------------------------------------------------------*/
