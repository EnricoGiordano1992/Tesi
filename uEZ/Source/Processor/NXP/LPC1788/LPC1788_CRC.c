...
/*---------------------------------------------------------------------------*
 * Routine:  ILPC1788_CRC_SetComputationType
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_CRC_SetComputationType(
        void *aWorkspace,
...
/*---------------------------------------------------------------------------*
 * Routine:  ILPC1788_CRC_AddModifier
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_CRC_AddModifier(
        void *aWorkspace,
...
/*---------------------------------------------------------------------------*
 * Routine:  ILPC1788_CRC_RemoveModifier
 *---------------------------------------------------------------------------*
 * Description:
 *      Add a modifier to the algorithm.  If the modifier already has been
 *      added, do nothing.
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_CRC_RemoveModifier(
        void *aWorkspace,
        T_uezCRCModifier aModifier)
{
    TUInt32 bits = ICRCModifierBits(aModifier);
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_CRC_SetSeed(void *aWorkspace, TUInt32 aSeed)
{
    PARAM_NOT_USED(aWorkspace);
...
/*---------------------------------------------------------------------------*
 * Routine:  ILPC1788_CRC_ComputeData
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_CRC_ComputeData(
        void *aWorkspace,
        void *aData,
...
/*---------------------------------------------------------------------------*
 * Routine:  ILPC1788_CRC_ReadChecksum
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_CRC_ReadChecksum(void *aWorkspace, TUInt32 *aValue)
{
    PARAM_NOT_USED(aWorkspace);
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_CRC_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC1788_CRC_InitializeWorkspace(void *aWorkspace)
{
    //T_LPC1788_CRC_Workspace *p = (T_LPC1788_CRC_Workspace *)aWorkspace;
    PARAM_NOT_USED(aWorkspace);
...
/*---------------------------------------------------------------------------*
 * Interface: LPC1788 CRC
 *---------------------------------------------------------------------------*/
const HAL_CRC CRC_LPC1788_Interface = {
        {
                "NXP:LPC1788:CRC",
                0x0110,
                LPC1788_CRC_InitializeWorkspace,
                sizeof(T_LPC1788_CRC_Workspace), },

        ILPC1788_CRC_SetComputationType,
        ILPC1788_CRC_AddModifier,
        ILPC1788_CRC_RemoveModifier,
        ILPC1788_CRC_SetSeed,
        ILPC1788_CRC_ComputeData,
        ILPC1788_CRC_ReadChecksum };

/*---------------------------------------------------------------------------*
 * Requirement routines:
 *---------------------------------------------------------------------------*/
void LPC1788_CRC0_Require(void)
{
    HAL_DEVICE_REQUIRE_ONCE();
    HALInterfaceRegister("CRC0", (T_halInterface *)&CRC_LPC1788_Interface, 0, 0);
}

/*-------------------------------------------------------------------------*
 * End of File:  LPC1788_CRC.c
 *-------------------------------------------------------------------------*/
