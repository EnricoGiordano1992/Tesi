...
typedef struct {
    ...
    TISRFPtr iISR;
#if LPC1788_INTERRUPT_TRACK_NAMES
    const char *iName;
#endif
} T_irqHandleStruct;
        ...
        const char * const aName)
{
	...
	whereas the LPC1788 has 32 interrupt levels. However all UEZ interrupts
...
// DEFAULT_IRQ_HANDLER(TIMER0_IRQHandler, TIMER0_IRQn);		defined by Enrico Giordano in modbus_function.c
...
//DEFAULT_IRQ_HANDLER(UART2_IRQHandler, UART2_IRQn);		defined by Enrico Giordano in modbus_function.c
