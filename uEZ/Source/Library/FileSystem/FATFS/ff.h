...
FRESULT f_get_drive(BYTE aDrive, FATFS **p_fs);     /* Get the FATFS object for the drive number */
FRESULT f_drive_sync(BYTE aDrive);                  /* Synchronize the drive (ensuring all data is saved) */
...
#define feof(fp) (((fp)->fptr == (fp)->fsize) ? 1 : 0)
#define ferror(fp) (((fp)->flag & FA__ERROR) ? 1 : 0)
#ifndef EOF
#define EOF -1
#endif
#endif
