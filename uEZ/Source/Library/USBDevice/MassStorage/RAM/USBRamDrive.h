 ...
 *
 *-------------------------------------------------------------------------*/
#ifndef _USB_RAM_DRIVE_H_
#define _USB_RAM_DRIVE_H_

typedef struct {
    void (*iUSBRamDriveActivity)(void *aWorkspace);
} T_USBRamDriveCallbacks;
...
#endif // _USB_RAM_DRIVE_H_

/*-------------------------------------------------------------------------*
 * End of File:  USBRamDrive.h
 *-------------------------------------------------------------------------*/
