/*-------------------------------------------------------------------------*
 * File:  ST_LIS3LV02DQ_driver.c
 *-------------------------------------------------------------------------*
 * Description:
 *      Device implementation of an ST LIS3LV02DQ Accelerometer.
 *-------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------
...
} T_ST_Accelo_LIS3LV02DQ_I2C_Workspace;
 ...
 * Inputs:
 *      T_ST_Accelo_LIS3LV02DQ_I2C_Workspace *p -- Workspace
...
T_uezError ST_Accelo_LIS3LV02DQ_I2C_GetInfo(
        void *aWorkspace,
 ...
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup LIS3LV02DQ control registers
 * Inputs:
 *      T_ST_Accelo_LIS3LV02DQ_I2C_Workspace *p -- Workspace
 * Outputs:
 *      T_uezError                  -- Error code, UEZ_ERROR_TIMEOUT if no
 *                                      reading.
 *---------------------------------------------------------------------------*/
T_uezError ST_Accelo_LIS3LV02DQ_Configure(void *aWorkspace, DEVICE_I2C_BUS **aI2C)
{
    I2C_Request r;
 ...
 *---------------------------------------------------------------------------*/
const DEVICE_Accelerometer Accelerometer_ST_LIS3LV02DQ_via_I2C_Interface = {
    // Common device interface
    {
	    "Accelerometer:ST:LIS3LV02DQ:I2C",
	    0x0100,
	    ST_Accelo_LIS3LV02DQ_I2C_InitializeWorkspace,
	    sizeof(T_ST_Accelo_LIS3LV02DQ_I2C_Workspace),
	},
...
/*-------------------------------------------------------------------------*
 * End of File:  ST_LIS3LV02DQ_driver.c
 *-------------------------------------------------------------------------*/
