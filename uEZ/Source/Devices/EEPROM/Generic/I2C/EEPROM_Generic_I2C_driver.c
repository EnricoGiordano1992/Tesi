/*-------------------------------------------------------------------------*
 * File:  EEPROM_Generic_I2C_driver.c
 *-------------------------------------------------------------------------*
 * Description:
...
typedef struct {
    ...
    DEVICE_I2C_BUS **iI2C;
    TUInt8 iI2CAddr;
    TUInt8 iPage[EEPROM_MAX_PAGE_SIZE+3];
    T_EEPROMConfig iConfig;
} T_EEPROM_Generic_I2C_Workspace;

/*---------------------------------------------------------------------------*
 * Routine:  EEPROM_Generic_I2C_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError EEPROM_Generic_I2C_InitializeWorkspace(void *aW)
{
    T_uezError error;

    T_EEPROM_Generic_I2C_Workspace *p = (T_EEPROM_Generic_I2C_Workspace *)aW;
...
/*---------------------------------------------------------------------------*
 * Routine:  EEPROM_Generic_I2C_Read
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError EEPROM_Generic_I2C_Read(
        void *aWorkspace,
        TUInt32 aAddress,
        TUInt8 *aBuffer,
        TUInt32 aNumBytes)
{
    T_EEPROM_Generic_I2C_Workspace *p = (T_EEPROM_Generic_I2C_Workspace *)aWorkspace;
    ...
    while (size) {
        ...
        r.iAddr = p->iI2CAddr|((aAddress>>8) & 0x3F);
...
/*---------------------------------------------------------------------------*
 * Routine:  EEPROM_Generic_I2C_Write
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError EEPROM_Generic_I2C_Write(
        void *aWorkspace,
        TUInt32 aAddress,
        TUInt8 *aBuffer,
        TUInt32 aNumBytes)
 ...
 *---------------------------------------------------------------------------*/
T_uezError EEPROM_Generic_I2C_SetConfiguration(
        void *aWorkspace,
...
/*---------------------------------------------------------------------------*
 * Routine:  EEPROM_Generic_I2C_Configure
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
const DEVICE_EEPROM EEPROM_Generic_I2C_Interface = {
	{
		// Common device interface
	    "EEPROM:Generic:I2C",
	    0x0100,
	    EEPROM_Generic_I2C_InitializeWorkspace,
	    sizeof(T_EEPROM_Generic_I2C_Workspace),
	},
	
    // Functions
    EEPROM_Generic_I2C_SetConfiguration,
    EEPROM_Generic_I2C_Read,
    EEPROM_Generic_I2C_Write,
} ;

/*-------------------------------------------------------------------------*
 * End of File:  EEPROM_Generic_I2C_driver.c
 *-------------------------------------------------------------------------*/
