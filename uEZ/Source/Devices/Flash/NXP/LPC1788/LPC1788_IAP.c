...
#if (LPC1788_IAP_PROTECT_FIRST_64K==1)
 ...
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_IAP_Start(TBool aNeedErasing)
{
    TUInt32 i;
 ...
 *      T_uezError -- UEZ_ERROR_NONE if successful, else error code.
 *---------------------------------------------------------------------------*/
T_uezError ILPC1788_IAP_End(void)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup of this workspace for Data Flash. For the NXP LPC1788, we allow the MCU to
 ...
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_InitializeWorkspace(void *aW)
{
    T_uezError error;

    T_Flash_NXP_LPC1788_Workspace *p = (T_Flash_NXP_LPC1788_Workspace *)aW;
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_Open
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_Open(void *aWorkspace)
{
    T_Flash_NXP_LPC1788_Workspace *p =
        (T_Flash_NXP_LPC1788_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_Close
 *---------------------------------------------------------------------------*
 * Description:
 *      Close the flash device.  For the NXP LPC1788, the flash area access
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_Close(void *aWorkspace)
{
    T_Flash_NXP_LPC1788_Workspace *p =
        (T_Flash_NXP_LPC1788_Workspace *)aWorkspace;
    if (p->iNumOpen) {
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_Read
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_Read(
    void *aWorkspace,
    TUInt32 aOffset,
    TUInt8 *aBuffer,
    TUInt32 aNumBytes)
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_Write
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_Write(
    void *aWorkspace,
    TUInt32 aOffset,
    TUInt8 *aBuffer,
    TUInt32 aNumBytes)
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_BlockErase
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_BlockErase(
    void *aWorkspace,
    TUInt32 aOffset,
    TUInt32 aNumBytes)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_ChipErase
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_ChipErase(void *aWorkspace)
{
    T_Flash_NXP_LPC1788_Workspace *p =
        (T_Flash_NXP_LPC1788_Workspace *)aWorkspace;
    T_uezError error;
    ...
    // Prepare the sector for erase
    UEZSemaphoreGrab(p->iSem, UEZ_TIMEOUT_INFINITE);
#if LPC1788_IAP_PROTECT_FIRST_64K
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_QueryReg
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_QueryReg(
    void *aWorkspace,
    TUInt32 aReg,
    TUInt32 *aValue)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_GetChipInfo
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_GetChipInfo(
    void *aWorkspace,
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1788_GetBlockInfo
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1788_GetBlockInfo(
    void *aWorkspace,
    TUInt32 aOffset,
...
void Flash_NXP_LPC1788_Create(const char *aName)
{
    UEZDeviceTableRegister(aName,
        (T_uezDeviceInterface *)&Flash_NXP_LPC1788_Interface, 0, 0);
}

/*---------------------------------------------------------------------------*
 * Device Interface table:
 *---------------------------------------------------------------------------*/
const DEVICE_Flash Flash_NXP_LPC1788_Interface = { {
// Common device interface
    "Flash:NXP:LPC1788:16Bit",
    0x0100, //<<---- What is the 0x100 stand for??
    Flash_NXP_LPC1788_InitializeWorkspace,
    sizeof(T_Flash_NXP_LPC1788_Workspace), },

// Functions
    Flash_NXP_LPC1788_Open,
    Flash_NXP_LPC1788_Close,
    Flash_NXP_LPC1788_Read,
    Flash_NXP_LPC1788_Write,
    Flash_NXP_LPC1788_BlockErase,
    Flash_NXP_LPC1788_ChipErase,
    Flash_NXP_LPC1788_QueryReg,
    Flash_NXP_LPC1788_GetChipInfo,
    Flash_NXP_LPC1788_GetBlockInfo, };
