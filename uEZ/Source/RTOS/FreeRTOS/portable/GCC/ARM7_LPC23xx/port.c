...
#define portTIMER_VIC_CHANNEL           ( ( unsigned portLONG ) 0x0005 )
#define portTIMER_VIC_CHANNEL_BIT       ( ( unsigned portLONG ) 0x0020 )
#define portTIMER_VIC_ENABLE            ( ( unsigned portLONG ) 0x0020 )
#endif
...
unsigned portLONG ulCompareMatch;
	...
	{
		extern void ( vPreemptiveTick )( void );
		VICVectAddr5 = ( portLONG ) vPreemptiveTick;
	}
	#else
	{
		extern void ( vNonPreemptiveTick )( void );
		VICVectAddr5 = ( portLONG ) vNonPreemptiveTick;
	}
	#endif
