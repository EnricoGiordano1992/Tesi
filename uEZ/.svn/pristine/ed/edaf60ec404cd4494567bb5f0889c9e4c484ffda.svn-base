 ...
 *     
 *-------------------------------------------------------------------------*/
#ifndef LPC1788_I2S_H_
#define LPC1788_I2S_H_
...
} T_LPC1788_I2S_Settings;

/*-------------------------------------------------------------------------*
 * Prototypes:
 *-------------------------------------------------------------------------*/
extern const HAL_I2S G_LPC1788_I2S_Interface;
void LPC1788_I2S_Require(const T_LPC1788_I2S_Settings *aSettings);

#endif // LPC1788_I2S_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC1788_I2S.h
 *-------------------------------------------------------------------------*/
