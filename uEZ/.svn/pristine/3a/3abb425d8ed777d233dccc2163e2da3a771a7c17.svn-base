/*-------------------------------------------------------------------------*
 * File:  ExternalInterrupt_NXP_LPC1768.c
 *-------------------------------------------------------------------------*
 * Description:
...
#include "ExternalInterrupt_NXP_LPC1768.h"
...
typedef struct {
    ...
    T_uezSemaphore iSem;
} T_ExternalInterrupt_NXP_LPC1768_Workspace;
...
static IRQ_ROUTINE(LPC1768_EINT1_Callback);
static IRQ_ROUTINE(LPC1768_EINT2_Callback);
static IRQ_ROUTINE(LPC1768_EINT3_Callback);
...
const TISRFPtr G_eintFuncs[NUM_EXTERNAL_INTERRUPTS] = {
    LPC1768_EINT0_Callback,
    LPC1768_EINT1_Callback,
    LPC1768_EINT2_Callback,
    LPC1768_EINT3_Callback,
};

/*---------------------------------------------------------------------------*
 * Routine:  ExternalInterrupt_NXP_LPC1768_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError ExternalInterrupt_NXP_LPC1768_InitializeWorkspace(void *aW)
{
    T_uezError error;
    TUInt8 i;

    T_ExternalInterrupt_NXP_LPC1768_Workspace *p =
            (T_ExternalInterrupt_NXP_LPC1768_Workspace *)aW;
...
{
    IRQ_START();
    ILPC1768_ProcessExternalInterrupt(0);
    IRQ_END();
}
static IRQ_ROUTINE(LPC1768_EINT1_Callback)
{
    IRQ_START();
    ILPC1768_ProcessExternalInterrupt(1);
    IRQ_END();
}
static IRQ_ROUTINE(LPC1768_EINT2_Callback)
{
    IRQ_START();
    ILPC1768_ProcessExternalInterrupt(2);
    IRQ_END();
}
static IRQ_ROUTINE(LPC1768_EINT3_Callback)
{
    IRQ_START();
    ILPC1768_ProcessExternalInterrupt(3);
    IRQ_END();
}

/*---------------------------------------------------------------------------*
 * Routine:  ExternalInterrupt_NXP_LPC1768_Set
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ExternalInterrupt_NXP_LPC1768_Set(
        void *aWorkspace,
        TUInt32 aChannel,
        ...
        const char *aName)
{
    TUInt32 irqNum;
    T_ExternalInterrupt_NXP_LPC1768_Workspace *p =
        (T_ExternalInterrupt_NXP_LPC1768_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  ExternalInterrupt_NXP_LPC1768_Reset
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ExternalInterrupt_NXP_LPC1768_Reset(
        void *aWorkspace,
        TUInt32 aChannel)
{
    TUInt32 irqNum;
...
/*---------------------------------------------------------------------------*
 * Routine:  ExternalInterrupt_NXP_LPC1768_Clear
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ExternalInterrupt_NXP_LPC1768_Clear(
        void *aWorkspace,
        TUInt32 aChannel)
{
    TUInt32 irqNum;
...
/*---------------------------------------------------------------------------*
 * Routine:  ExternalInterrupt_NXP_LPC1768_Disable
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ExternalInterrupt_NXP_LPC1768_Disable(
        void *aWorkspace,
        TUInt32 aChannel)
{
    TUInt32 irqNum;
...
/*---------------------------------------------------------------------------*
 * Routine:  ExternalInterrupt_NXP_LPC1768_Enable
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError ExternalInterrupt_NXP_LPC1768_Enable(
        void *aWorkspace,
        TUInt32 aChannel)
{
    TUInt32 irqNum;
 ...
 *---------------------------------------------------------------------------*/
const DEVICE_ExternalInterrupt ExternalInterrupt_NXP_LPC1768_Interface = {
	{
    ...
    ExternalInterrupt_NXP_LPC1768_Clear,
    ExternalInterrupt_NXP_LPC1768_Disable,
    ExternalInterrupt_NXP_LPC1768_Enable,
} ;

/*-------------------------------------------------------------------------*
 * End of File:  ExternalInterrupt_NXP_LPC1768.c
 *-------------------------------------------------------------------------*/
