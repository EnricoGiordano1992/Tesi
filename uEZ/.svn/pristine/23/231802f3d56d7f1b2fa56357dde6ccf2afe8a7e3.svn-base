...
#include <Source/Processor/NXP/LPC1788/LPC1788_ExternalBus.h>
#include <uEZBSP.h>
...
void LPC1788_EMC_Static_Init(const T_LPC1788_EMC_Static_Configuration *aConfig)
{
    ...
    if (aConfig->iBaseAddress == 0x80000000) {
        ...
        emc = (T_LPC1788_EMC_Static_Regs *)&LPC_EMC->StaticConfig1;
        /* CSN[1] @ P4.31 */
        LPC_IOCON->P4_31 = (LPC_IOCON->P4_31 & ~7) | 1;
    } else if (aConfig->iBaseAddress == 0x98000000) {
        emc = (T_LPC1788_EMC_Static_Regs *)&LPC_EMC->StaticConfig2;
        /* CSN[2] @ P2.14 */
        LPC_IOCON->P2_14 = (LPC_IOCON->P2_14 & ~7) | 1;
    } else {
        emc = (T_LPC1788_EMC_Static_Regs *)&LPC_EMC->StaticConfig3;
        /* CSN[3] @ P2.15 */
    ...
    LPC1788_ExternalAddressBus_ConfigureIOPins(numAddrBits);
...
/*-------------------------------------------------------------------------*
 * End of File:  LPC1788_EMC_Static.c
 *-------------------------------------------------------------------------*/
