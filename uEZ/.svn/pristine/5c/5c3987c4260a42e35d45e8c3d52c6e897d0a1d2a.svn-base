...
#if (LPC1756_IAP_PROTECT_FIRST_32K==1)
    {  -1,  0x00000000, 0x00008000 }, // Ignore first 32K
#else
...
TBool G_sectorsNeedingErase[MAX_NUM_SECTORS];
TUInt8 G_block[BLOCK_SIZE];
TUInt32 G_parameters[5];
TUInt32 G_results[4];
TUInt32 G_lastBlock;
 ...
 *---------------------------------------------------------------------------*/
T_uezError ILPC1756_IAP_Start(TBool aNeedErasing)
{
    TUInt32 i;
 ...
 *      T_uezError -- UEZ_ERROR_NONE if successful, else error code.
 *---------------------------------------------------------------------------*/
T_uezError ILPC1756_IAP_End(void)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 *      Setup of this workspace for Data Flash. For the NXP LPC1756, we allow the MCU to
 ...
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_InitializeWorkspace(void *aW)
{
    T_uezError error;

    T_Flash_NXP_LPC1756_Workspace *p = (T_Flash_NXP_LPC1756_Workspace *)aW;
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_Open
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_Open(void *aWorkspace)
{
    T_Flash_NXP_LPC1756_Workspace *p =
        (T_Flash_NXP_LPC1756_Workspace *)aWorkspace;
...
//        ILPC1756_IAP_Start(EFalse); // we don't erase by default
          ILPC1756_IAP_Start(ETrue); // we don't erase by default
    }
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_Close
 *---------------------------------------------------------------------------*
 * Description:
 *      Close the flash device.  For the NXP LPC1756, the flash area access
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_Close(void *aWorkspace)
{
    T_Flash_NXP_LPC1756_Workspace *p =
        (T_Flash_NXP_LPC1756_Workspace *)aWorkspace;
    if (p->iNumOpen) {
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_Read
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_Read(
    void *aWorkspace,
    TUInt32 aOffset,
    TUInt8 *aBuffer,
    TUInt32 aNumBytes)
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_Write
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_Write(
    void *aWorkspace,
    TUInt32 aOffset,
    TUInt8 *aBuffer,
    TUInt32 aNumBytes)
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_BlockErase
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_BlockErase(
    void *aWorkspace,
    TUInt32 aOffset,
    TUInt32 aNumBytes)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_ChipErase
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_ChipErase(void *aWorkspace)
{
    T_Flash_NXP_LPC1756_Workspace *p =
        (T_Flash_NXP_LPC1756_Workspace *)aWorkspace;
    T_uezError error;
    ...
    // Prepare the sector for erase
    UEZSemaphoreGrab(p->iSem, UEZ_TIMEOUT_INFINITE);
#if LPC1756_IAP_PROTECT_FIRST_64K
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_QueryReg
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_QueryReg(
    void *aWorkspace,
    TUInt32 aReg,
    TUInt32 *aValue)
{
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_GetChipInfo
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_GetChipInfo(
    void *aWorkspace,
...
/*---------------------------------------------------------------------------*
 * Routine:  Flash_NXP_LPC1756_GetBlockInfo
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                   -- Error code
 *---------------------------------------------------------------------------*/
T_uezError Flash_NXP_LPC1756_GetBlockInfo(
    void *aWorkspace,
    TUInt32 aOffset,
 ...
 *---------------------------------------------------------------------------*/
const DEVICE_Flash Flash_NXP_LPC1756_Interface = { {
// Common device interface
    "Flash:NXP:LPC1756:16Bit",
    0x0100, //<<---- What is the 0x100 stand for??
    Flash_NXP_LPC1756_InitializeWorkspace,
    sizeof(T_Flash_NXP_LPC1756_Workspace), },

// Functions
    Flash_NXP_LPC1756_Open,
    Flash_NXP_LPC1756_Close,
    Flash_NXP_LPC1756_Read,
    Flash_NXP_LPC1756_Write,
    Flash_NXP_LPC1756_BlockErase,
    Flash_NXP_LPC1756_ChipErase,
    Flash_NXP_LPC1756_QueryReg,
    Flash_NXP_LPC1756_GetChipInfo,
    Flash_NXP_LPC1756_GetBlockInfo, };

/*-------------------------------------------------------------------------*
 * End of File:  LPC1756_IAP.c
 *-------------------------------------------------------------------------*/
