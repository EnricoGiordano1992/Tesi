 ...
 *-------------------------------------------------------------------------*
 * Description:
 *     Contains definitions for the CARRIER_RX63N platform.
 *-------------------------------------------------------------------------*/
...
#define RX63N_PACKAGE               RX63N_PACKAGE_BGA176
...
#define SDRAM_NUM_ROWS      4096//2048
#define SDRAM_REFRESH_TIME  64//32  // ms
