/*-------------------------------------------------------------------------*
 * File:  LPC1788_USBDev.c
 *-------------------------------------------------------------------------*
 * Description:
 *      HAL implementation of the LPC1788 USBDev (Ethernet) Driver.
 * Implementation:
 *
 *-------------------------------------------------------------------------*/
...
} T_LPC1788_USBDev_Workspace;

/*---------------------------------------------------------------------------*
 * Globals:
 *---------------------------------------------------------------------------*/
extern const HAL_USBDeviceController LPC1788_USBDev_Interface;
T_LPC1788_USBDev_Workspace *G_LPC1788_USBDev_Workspace=0;

/*---------------------------------------------------------------------------*
 * Prototypes:
 *---------------------------------------------------------------------------*/
static void LPC1788_USBDev_EndpointConfigure(
        void *aWorkspace,
        TUInt8 aEndpoint,
...
/*-------------------------------------------------------------------------*
 * Internal Function:  ILPC1788_USBDev_Command
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
static void ILPC1788_USBDev_Command(
            T_LPC1788_USBDev_Workspace *p,
            TUInt8 aCommand)
{
...
/*-------------------------------------------------------------------------*
 * Internal Function:  ILPC1788_USBDev_CommandAndWrite
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
static void ILPC1788_USBDev_CommandAndWrite(
                T_LPC1788_USBDev_Workspace *p,
                TUInt8 aCommand,
                TUInt16 aData)
{
    // First, write the command
    ILPC1788_USBDev_Command(p, aCommand);
...
/*-------------------------------------------------------------------------*
 * Internal Function:  ILPC1788_USBDev_CommandAndRead
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
static TUInt8 ILPC1788_USBDev_CommandAndRead(
                T_LPC1788_USBDev_Workspace *p,
                TUInt8 aCommand)
{
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_InterruptNakEnable
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_InterruptNakEnable(
            void *aWorkspace,
            TUInt8 aNakBits)
{
    T_LPC1788_USBDev_Workspace *p = (T_LPC1788_USBDev_Workspace *)aWorkspace;

    ILPC1788_USBDev_CommandAndWrite(p, USB_DEVICE_CMD_SET_MODE, aNakBits);
}

/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_EndpointInterruptsEnable
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_EndpointInterruptsEnable(
                void *aWorkspace,
                TUInt8 aEndpoint)
{
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_EndpointInterruptsDisable
 *-------------------------------------------------------------------------*
 * Description:
 *      Allow an endpoint to generate interrupts.
 * Inputs:
 ...
 *      TUInt8 aEndpoint            -- Endpoint to trigger interrupts
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_EndpointInterruptsDisable(
                void *aWorkspace,
                TUInt8 aEndpoint)
{
    TUInt32 aIndex = IEndpointToIndex(aEndpoint);
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_USBDev_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError LPC1788_USBDev_InitializeWorkspace(void *aWorkspace)
{
    T_LPC1788_USBDev_Workspace *p = (T_LPC1788_USBDev_Workspace *)aWorkspace;
    ...
    G_LPC1788_USBDev_Workspace = p;

    return UEZ_ERROR_NONE;
}

/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_USBDev_Configure
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError LPC1788_USBDev_Configure(
        void *aWorkspace,
        T_USBDeviceControllerSettings *iSettings)
{
    T_LPC1788_USBDev_Workspace *p = (T_LPC1788_USBDev_Workspace *)aWorkspace;
...
/*---------------------------------------------------------------------------*
 * Routine:  ILPC1788_USBDev_InterruptProcess
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      void *aWorkspace          -- USBDev Controller's workspace
 *---------------------------------------------------------------------------*/
static void ILPC1788_USBDev_InterruptProcess(T_LPC1788_USBDev_Workspace *p)
{
    TUInt32 status;
    ...
    if (status & DEV_STAT) {
        ...
        usbStatus = (T_USBStatus)ILPC1788_USBDev_CommandAndRead(
                        p,
...
/*---------------------------------------------------------------------------*
 * Routine:  LPC1788_USBDev_ProcessEndpoints
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      void *aWorkspace          -- USBDev Controller's workspace
 *---------------------------------------------------------------------------*/
void LPC1788_USBDev_ProcessEndpoints(void *aWorkspace)
{
    T_LPC1788_USBDev_Workspace *p = (T_LPC1788_USBDev_Workspace *)aWorkspace;
    TUInt32 i;
...
/*---------------------------------------------------------------------------*
 * Routine:  ILPC1788_USBDev_InterruptVector
 *---------------------------------------------------------------------------*
 * Description:
 *      Process USB Device Interrupts
 *---------------------------------------------------------------------------*/
void LPC1788_InterruptProcess_USBDevice(void)
{
    if (G_LPC1788_USBDev_Workspace)
        ILPC1788_USBDev_InterruptProcess(G_LPC1788_USBDev_Workspace);
}

/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_Connect
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *      void *aWorkspace          -- USBDev Controller's workspace
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_Connect(void *aWorkspace)
{
    ILPC1788_USBDev_CommandAndWrite(
        (T_LPC1788_USBDev_Workspace *)aWorkspace,
        USB_DEVICE_CMD_STATUS,
        USB_STATUS_CONNECT);
}

/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_Disconnect
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *      void *aWorkspace          -- USBDev Controller's workspace
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_Disconnect(void *aWorkspace)
{
    ILPC1788_USBDev_CommandAndWrite(
        (T_LPC1788_USBDev_Workspace *)aWorkspace,
        USB_DEVICE_CMD_STATUS,
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_SetAddress
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
void LPC1788_USBDev_SetAddress(void *aWorkspace, TUInt8 aAddress)
{
    ILPC1788_USBDev_CommandAndWrite(
        (T_LPC1788_USBDev_Workspace *)aWorkspace,
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_DeviceIsConfigured
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *      void *aWorkspace          -- USBDev Controller's workspace
 *-------------------------------------------------------------------------*/
void LPC1788_USBDev_DeviceIsConfigured(void *aWorkspace)
{
    ILPC1788_USBDev_CommandAndWrite(
            (T_LPC1788_USBDev_Workspace *)aWorkspace,
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_DeviceIsNotConfigured
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *      void *aWorkspace          -- USBDev Controller's workspace
 *-------------------------------------------------------------------------*/
void LPC1788_USBDev_DeviceIsNotConfigured(void *aWorkspace)
{
    ILPC1788_USBDev_CommandAndWrite(
        (T_LPC1788_USBDev_Workspace *)aWorkspace,
        USB_DEVICE_CMD_CONFIG,
...
dprintf("[R %d %d]", aEndpoint, iMaxLen);
    ...
    ILPC1788_USBDev_Command(p, USB_ENDPOINT_CMD_SELECT | aIndex);
    ILPC1788_USBDev_Command(p, USB_ENDPOINT_CMD_CLEAR_BUFFER);

    return rxLength;
}

/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_Write
 *-------------------------------------------------------------------------*
 * Description:
...
dprintf("[W %d %d]", aEndpoint, aLength);
    ...
    ILPC1788_USBDev_Command(p, USB_ENDPOINT_CMD_SELECT | aIndex);
    ILPC1788_USBDev_Command(p, USB_ENDPOINT_CMD_VALIDATE_BUFFER);

    return aLength;
}

/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_SetStallState
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *                                     not stalled.
 *-------------------------------------------------------------------------*/
void LPC1788_USBDev_SetStallState(
            void *aWorkspace,
            TUInt8 aEndpoint,
            TBool aStallState)
{
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_IsStalled
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
TBool LPC1788_USBDev_IsStalled(void *aWorkspace, TUInt8 aEndpoint)
{
    // Determine if the endpoint's stalled bit is set.
    return (ILPC1788_USBDev_CommandAndRead(
                (T_LPC1788_USBDev_Workspace *)aWorkspace,
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_SetConfiguration
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_SetConfiguration(
                void *aWorkspace,
                TUInt8 aConfigurationIndex)
{
    T_LPC1788_USBDev_Workspace *p_workspace =
            (T_LPC1788_USBDev_Workspace *)aWorkspace;
...
dprintf("\n\n---> [Cf %d]", aConfigurationIndex);
    ...
    if (aConfigurationIndex == 0)  {
        ...
        LPC1788_USBDev_DeviceIsNotConfigured(aWorkspace);
    } else {
...
//                    ((T_USBDescriptorConfiguration *)p)->iConfigurationValue;
                ...
                LPC1788_USBDev_EndpointConfigure(
                    aWorkspace,
                    p_endpoint->iAddress,
        ...
        LPC1788_USBDev_DeviceIsConfigured((void *)p_workspace);
    }
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_GetConfiguration
 *-------------------------------------------------------------------------*
 * Description:
 *      Go through the descriptor table and enable all endpoints for
 *      the given descriptor index and alternative setting.
 ...
 *-------------------------------------------------------------------------*/
static TUInt8 LPC1788_USBDev_GetConfiguration(
                void *aWorkspace)
{
    T_LPC1788_USBDev_Workspace *p_workspace =
            (T_LPC1788_USBDev_Workspace *)aWorkspace;
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_ForceAddressAndConfiguration
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
void LPC1788_USBDev_ForceAddressAndConfiguration(
            void *aWorkspace,
            TUInt8 aAddress,
            TUInt8 aConfigNum)
{
    ...
    LPC1788_USBDev_SetAddress(aWorkspace, aAddress);
    LPC1788_USBDev_SetConfiguration(aWorkspace, aConfigNum);
 ...
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_EndpointEnable(
                T_LPC1788_USBDev_Workspace *p,
                int aIndex)
{
    ILPC1788_USBDev_CommandAndWrite(
...
/*-------------------------------------------------------------------------*
 * Internal Function:  LPC1788_USBDev_EndpointDisable
 *-------------------------------------------------------------------------*
 * Description:
 *      Disable endpoint.
 * Inputs:
 ...
 *-------------------------------------------------------------------------*/
#if 0
static void LPC1788_USBDev_EndpointDisable(
                T_LPC1788_USBDev_Workspace *p,
                int aIndex)
{
    ILPC1788_USBDev_CommandAndWrite(
...
/*-------------------------------------------------------------------------*
 * Internal Function:  LPC1788_USBDev_EndpointRealize
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
static void LPC1788_USBDev_EndpointRealize(
                T_LPC1788_USBDev_Workspace *p,
                TUInt32 aIndex,
                TUInt16 aMaxPacketSize)
{
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_EndpointConfigure
 *-------------------------------------------------------------------------*
 * Description:
            ...
            TUInt16 aMaxPacketSize)
{
    ...
    // realise EP
    LPC1788_USBDev_EndpointRealize(p, aIndex, aMaxPacketSize);

    // enable EP
    LPC1788_USBDev_EndpointEnable(
            p,
            aIndex);
}
 ...
 *      void *aWorkspace          -- USBDev Controller's workspace
 *-------------------------------------------------------------------------*/
void LPC1788_USBDev_Initialize(void *aWorkspace)
{
...
//    LPC1788_USBDev_InterruptNakEnable(aWorkspace, 0);
    LPC1788_USBDev_InterruptNakEnable(aWorkspace, USB_DEVICE_SET_MODE_INAK_BI);

    // Setup interrupts for endpoints
    for (i=0; i<MAX_NUM_ENDPOINTS; i++)  {
        if (p->iSettings.iUSBDevice->iEndpointFuncs[i].iIn)
            LPC1788_USBDev_EndpointInterruptsEnable(aWorkspace,
...
/*-------------------------------------------------------------------------*
 * Function:  LPC1788_USBDev_GetDescriptor
 *-------------------------------------------------------------------------*
 * Description:
 ...
 *-------------------------------------------------------------------------*/
const TUInt8 *LPC1788_USBDev_GetDescriptor(
            void *aWorkspace,
            TUInt8 aType,
            TUInt16 aIndex,
            TUInt16 *aLength)
{
    const TUInt8 *p = ((T_LPC1788_USBDev_Workspace *)aWorkspace)->
 ...
 * HAL Interface table:
 *---------------------------------------------------------------------------*/
const HAL_USBDeviceController LPC1788_USBDev_Interface = {
	{
	    "NXP:LPC1788:USB Device Controller",
	    0x0100,
	    LPC1788_USBDev_InitializeWorkspace,
	    sizeof(T_LPC1788_USBDev_Workspace),
	},
	
    LPC1788_USBDev_Configure,
    LPC1788_USBDev_Initialize,
    LPC1788_USBDev_Connect,
    LPC1788_USBDev_Disconnect,
    LPC1788_USBDev_SetAddress,
    LPC1788_USBDev_SetConfiguration,
    LPC1788_USBDev_GetConfiguration,
    LPC1788_USBDev_EndpointConfigure,
    LPC1788_USBDev_Read,
    LPC1788_USBDev_Write,
    LPC1788_USBDev_SetStallState,
    LPC1788_USBDev_IsStalled,
    LPC1788_USBDev_EndpointInterruptsEnable,
    LPC1788_USBDev_EndpointInterruptsDisable,
    LPC1788_USBDev_ForceAddressAndConfiguration,
    LPC1788_USBDev_ProcessEndpoints,
    LPC1788_USBDev_GetDescriptor,
    LPC1788_USBDev_InterruptNakEnable,
};

/*---------------------------------------------------------------------------*
 * Requirement routines:
 *---------------------------------------------------------------------------*/
void LPC1788_USBDevice_PortA_Require(
        const T_LPC1788_USBDevice_Settings *aSettings)
{
    static const T_LPC1788_IOCON_ConfigList pinsVBUS[] = {
    ...
    HALInterfaceRegister("USBDeviceController",
            (T_halInterface *)&LPC1788_USBDev_Interface, 0, 0);

    LPC1788_IOCON_ConfigPinOrNone(aSettings->iVBUS, pinsVBUS, ARRAY_COUNT(pinsVBUS));
...
void LPC1788_USBDevice_PortB_Require(
        const T_LPC1788_USBDevice_Settings *aSettings)
{
    static const T_LPC1788_IOCON_ConfigList pinsVBUS[] = {
            {GPIO_P1_30, IOCON_A_DEFAULT(2)}, // USB_VBUS
