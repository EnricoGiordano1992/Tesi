...
#include "RX63N_DirectDrive_LCDController.h"
 ...
 * Globals:
 *---------------------------------------------------------------------------*/
const HAL_LCDController LCDController_RX63N_DirectDrive_Interface;

/*---------------------------------------------------------------------------*
 * Routine:  RX63N_DirectDrive_InitializeWorkspace
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *---------------------------------------------------------------------------*/
T_uezError RX63N_DirectDrive_InitializeWorkspace(void *aWorkspace)
{
    T_workspace *p = (T_workspace *)aWorkspace;
    p->iHAL = &LCDController_RX63N_DirectDrive_Interface;
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError RX63N_DirectDrive_Off(void *aWorkspace)
{
    // Ensure the LCD is enabled and powered
    LCDOff();
...
/*---------------------------------------------------------------------------*
 * Routine:  RX63N_DirectDrive_SetBacklightLevel
 *---------------------------------------------------------------------------*
 * Description:
 ...
 *      T_uezError                 -- Error code
 *---------------------------------------------------------------------------*/
T_uezError RX63N_DirectDrive_SetBacklightLevel(
                void *aWorkspace,
                TUInt32 aLevel)
{
#if 0
 ...
 *---------------------------------------------------------------------------*/
const HAL_LCDController LCDController_RX63N_DirectDrive_Interface = {
    "RX63N:DirectDrive:LCDController",
    0x0100,
    RX63N_DirectDrive_InitializeWorkspace,
    sizeof(T_workspace),

    LCDCONTROLLER_FEATURE_POWER|
        LCDCONTROLLER_FEATURE_DYNAMIC_BASE_ADDR,

    RX63N_DirectDrive_Configure,
    RX63N_DirectDrive_On,
    RX63N_DirectDrive_Off,
    RX63N_DirectDrive_SetBacklightLevel,
    RX63N_DirectDrive_SetBaseAddr,
    0, // RX63N_DirectDrive_SetPaletteColor,
};
