...
/*
 * These macros should not be called directly, but through the taskENTER_CRITICAL()
 * and taskEXIT_CRITICAL() macros.
 */
#define portENABLE_INTERRUPTS() 	setpsw_i() // Requires RX Toolset v1.1.0.0!
#define portDISABLE_INTERRUPTS() 	clrpsw_i() // Requires RX Toolset v1.1.0.0!
