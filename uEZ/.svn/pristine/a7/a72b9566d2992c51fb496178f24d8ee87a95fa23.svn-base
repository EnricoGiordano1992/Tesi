...
#define DEFAULT_CONTEXT_MEMBERS \
  ...
  void (* pfCopyBuffer)(int LayerIndex, int IndexSrc, int IndexDst); \
  void (* pfDrawBMP1)  (int LayerIndex, int x, int y, U8 const * p, int Diff, int xSize, int ySize, int BytesPerLine, const LCD_PIXELINDEX * pTrans); \
