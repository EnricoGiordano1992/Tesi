 ...
 *-------------------------------------------------------------------------*/
#ifndef LPC1788_PLL_H_
#define LPC1788_PLL_H_
 ...
 * Constants:
 *-------------------------------------------------------------------------*/
#define LPC1788_IRC_FREQUENCY       12000000 // Hz +/- 1%

/*-------------------------------------------------------------------------*
 * Types:
 *-------------------------------------------------------------------------*/
typedef enum {
    LPC1788_CLKSRC_SELECT_INTERNAL_RC = 0,
    LPC1788_CLKSRC_SELECT_MAIN_OSCILLATOR = 1
} T_LPC1788_ClockSourceSelect;

typedef enum {
    // sysclk
    LPC1788_CPU_CLOCK_SELECT_SYSCLK = 0,

    // pll_clk
    LPC1788_CPU_CLOCK_SELECT_PLL_CLK = 1,
} T_LPC1788_CPUClockSelect;

typedef enum {
    // sysclk
    LPC1788_USB_CLOCK_SELECT_SYSCLK = 0,

    // pll_clk
    LPC1788_USB_CLOCK_SELECT_PLL_CLK = 1,

    // alt_pll_clk
    LPC1788_USB_CLOCK_SELECT_ALT_PLL_CLK = 2,
} T_LPC1788_USBClockSelect;

typedef enum {
    LPC1788_CLOCK_OUT_SELECT_CPU = 0,
    LPC1788_CLOCK_OUT_SELECT_MAIN_OSC = 1,
    LPC1788_CLOCK_OUT_SELECT_IRC_OSC = 2,
    LPC1788_CLOCK_OUT_SELECT_USB = 3,
    LPC1788_CLOCK_OUT_SELECT_RTC = 4,
    LPC1788_CLOCK_OUT_SELECT_WATCHDOG = 6,
} T_LPC1788_ClockOutSelect;
...
typedef struct {
        ...
        // Selectors:
        T_LPC1788_ClockSourceSelect iClockSourceSelect;
        T_LPC1788_CPUClockSelect iCPUClockSelect;
        T_LPC1788_USBClockSelect iUSBClockSelect;
        ...
        // CLK OUT selection:
        T_LPC1788_ClockOutSelect iClockOutSelect;
        TUInt8 iClockOutDivider; // 1-16
        TBool iClockOutEnable;
} T_LPC1788_PLL_Frequencies;
...
#endif // LPC1788_PLL_H_
/*-------------------------------------------------------------------------*
 * End of File:  LPC1788_PLL.h
 *-------------------------------------------------------------------------*/
