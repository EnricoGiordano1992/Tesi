 ...
 *-------------------------------------------------------------------------*/
/** @addtogroup Temperature_ADT7420 
 * @{
 *     @brief Temperature sensor driver using the ADT7420 over I2C.
 */
/*-------------------------------------------------------------------------*/
#include <stdbool.h>
#include <stdint.h>
 ...
 *      
 *  @return     uint16_t -- temperature with 4 bits of fraction and 12 bits of
 *          integer.
 */
/*---------------------------------------------------------------------------*/
