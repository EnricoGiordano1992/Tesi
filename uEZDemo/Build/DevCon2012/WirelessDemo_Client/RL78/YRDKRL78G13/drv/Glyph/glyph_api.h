...
extern const uint8_t * const Font8x8_subset_table[256];
...
typedef struct _glyph_version_info
{
    ...
    int16_t nVersionAPIMajor ;
    int16_t nVersionAPIMinor ;
    int16_t nVersionIMPLMajor ;
    int16_t nVersionIMPLMinor ;
    int16_t nImplementationID ;
} T_glyphVersionInfo ;
...
typedef struct {
    ...
    uint16_t iCharX_Position;
    uint16_t iCharY_Position;
    uint16_t iCharX2_Position;
    uint16_t iCharY2_Position;
    uint16_t iCharFont;
    uint16_t iFP_API_MAJOR_VERSION;
    uint16_t iFP_API_MINOR_VERSION;
    uint16_t iFP_IMPLEMENTATION_ID;
    uint16_t iFP_IMPL_MAJOR_VERSION;
    uint16_t iFP_IMPL_MINOR_VERSION;
    uint16_t iMAX_HEIGHT;
    uint16_t iMAX_WIDTH;
    ...
    T_glyphError (*iOpen)(T_glyphHandle aHandle, uint16_t aAddress);
    T_glyphError (*iClose)(T_glyphHandle aHandle);
    T_glyphError (*iRead)(T_glyphHandle aHandle, uint16_t aRegister, uint16_t *Value);
    T_glyphError (*iWrite)(T_glyphHandle aHandle, uint16_t aRegister, uint16_t Value);
} T_LCD_API ;
...
******************************************************************************/
T_glyphError GlyphOpen(T_glyphHandle *aHandle, int16_t aAddress);
T_glyphError GlyphClose(T_glyphHandle *aHandle);
T_glyphError GlyphWrite(T_glyphHandle aHandle, uint16_t aRegister, uint16_t aValue);
T_glyphError GlyphRead(T_glyphHandle aHandle, uint16_t aRegister, uint16_t *aValue);
...
T_glyphError GlyphSetX(T_glyphHandle aHandle, uint16_t aX);
T_glyphError GlyphSetY(T_glyphHandle aHandle, uint16_t aY);
T_glyphError GlyphSetXY(T_glyphHandle aHandle, uint16_t aX, uint16_t aY);
T_glyphError GlyphGetXY(T_glyphHandle aHandle, uint16_t *aX, uint16_t *aY);
...
T_glyphError GlyphChar(T_glyphHandle aHandle, uint16_t aChar);
T_glyphError GlyphString(T_glyphHandle aHandle, uint8_t * aString, uint16_t aLength);
...
T_glyphError GlyphDrawBlock(T_glyphHandle aHandle, uint16_t aX1, uint16_t aY1, uint16_t aX2, uint16_t aY2);
T_glyphError GlyphEraseBlock(T_glyphHandle aHandle, uint16_t aX1, uint16_t aY1, uint16_t aX2, uint16_t aY2);
T_glyphError GlyphSetContrast(T_glyphHandle aHandle, int16_t nContrast) ;
